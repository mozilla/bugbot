...
urls = [
    ...
    (5, ["Unlanded ESR31 Bugs", "unlanded_esr31", unlanded_esr31_url, 0]),
    ...
    (5, ["Tracked or Nominated for Tracking with Need-Info? ESR31 Bugs", "needinfo_esr31", needinfo_esr31_url, 0]),
    ...
    (0, ["Bugs Tracked for ESR31", "tracking_esr31", tracking_esr31_url, 0]),
