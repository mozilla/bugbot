...
no_nag = ";field0-0-0=status_whiteboard;type0-0-0=notsubstring;value0-0-0=[no-nag]"
...
unlanded_beta_url =	getReportURL("approval-mozilla-beta", 	cycle_span) + ";field0-0-0=cf_status_firefox" + beta_version + ";type0-0-0=nowordssubstr;value0-0-0=unaffected%2C fixed%2C verified%2C wontfix %2C disabled" + no_nag
unlanded_aurora_url =	getReportURL("approval-mozilla-aurora", cycle_span) + ";field0-0-0=cf_status_firefox" + aurora_version + ";type0-0-0=nowordssubstr;value0-0-0=unaffected%2C fixed%2C verified%2C wontfix %2C disabled" + no_nag
unlanded_esr17_url =	getReportURL("approval-mozilla-esr17",	cycle_span) + ";field0-0-0=cf_status_firefox_esr" + esr_version + ";type0-0-0=nowordssubstr;value0-0-0=unaffected%2C fixed%2C verified%2C wontfix %2C disabled" + no_nag
...
tracking_esr17_url =  "https://bugzilla.mozilla.org/buglist.cgi?type0-1-0=nowordssubstr;field0-1-0=cf_status_firefox_esr17;field0-0-0=cf_tracking_firefox_esr17;value0-1-0=fixed%20verified%20disabled%20wontfix%20unaffected;type0-0-0=equals;value0-0-0=" + beta_version + "%2B" + no_nag

urls = [unlanded_beta_url, unlanded_aurora_url, unlanded_esr17_url, tracking_beta_url, tracking_aurora_url, tracking_central_url, tracking_esr17_url, tracking_beta_touch_url, tracking_aurora_touch_url, tracking_central_touch_url]
