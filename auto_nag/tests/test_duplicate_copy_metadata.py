...
from auto_nag.scripts.duplicate_copy_metadata import DuplicateCopyMetadata


class TestDuplicateCopyMetadata(unittest.TestCase):
    comments = [
        "The following field has been copied from a duplicate bug:\n| Field | Value | Source |\n| ----- | ----- | ------ |\n| Severity | S3 | bug 1790853 |\n\n\nFor more information, please visit [auto_nag documentation](https://wiki.mozilla.org/Release_Management/autonag#duplicate_copy_metadata.py).",
