...
tracking_central_url = "https://bugzilla.mozilla.org/buglist.cgi?negate1=1;field0-3-0=cf_status_firefox" + nightly_version + ";type1-0-0=equals;type0-1-0=notequals;type0-5-0=notequals;value0-5-0=disabled;value0-4-0=verified;type3-0-0=notequals;field0-1-0=cf_status_firefox" + nightly_version + ";field0-0-0=cf_tracking_firefox" + nightly_version + ";type0-4-0=notequals;value3-0-0=%2B;field0-6-0=cf_status_firefox" + nightly_version + ";value0-3-0=unaffected;field3-0-0=cf_tracking_firefox" + beta_version + ";value0-2-0=fixed;value0-6-0=verified%20disabled;value0-1-0=wontfix;type0-3-0=notequals;value1-0-0=core-security;field0-2-0=cf_status_firefox" + nightly_version + ";field0-5-0=cf_status_firefox" + nightly_version + ";field0-4-0=cf_status_firefox" + nightly_version + ";type0-6-0=notequals;type0-0-0=equals;value0-0-0=%2B;type0-2-0=notequals;field1-0-0=bug_group;field2-1-0=status_whiteboard;type2-1-0=notsubstring;value2-1-0=[no-nag]"
...
tracking_central_touch_url = "https://bugzilla.mozilla.org/buglist.cgi?negate1=1;field0-3-0=cf_status_firefox" + nightly_version + ";type1-0-0=equals;type0-1-0=notequals;type0-5-0=notequals;value0-5-0=disabled;value0-4-0=verified;type3-0-0=greaterthan;field0-1-0=cf_status_firefox" + nightly_version + ";field0-0-0=cf_tracking_firefox" + nightly_version + ";type0-4-0=notequals;value3-0-0=3;value2-0-0=%2B;field2-0-0=cf_tracking_firefox" + beta_version + ";field0-6-0=cf_status_firefox" + nightly_version + ";value0-3-0=unaffected;field3-0-0=days_elapsed;type2-0-0=notequals;value0-2-0=fixed;value0-6-0=verified%" + nightly_version + "disabled;value0-1-0=wontfix;type0-3-0=notequals;value1-0-0=core-security;field0-2-0=cf_status_firefox" + nightly_version + ";field0-5-0=cf_status_firefox" + nightly_version + ";field0-4-0=cf_status_firefox" + nightly_version + ";type0-6-0=notequals;type0-0-0=equals;value0-0-0=%2B;type0-2-0=notequals;field1-0-0=bug_group" + no_nag
...
needinfo_central_url = "https://bugzilla.mozilla.org/buglist.cgi?f1=cf_tracking_firefox" + nightly_version + "&v6=fixed%2Cwontfix%2Cunaffected%2Cverified%2Cdisabled&o1=anywords&resolution=---&o6=anywords&f12=flagtypes.name&v12=needinfo%3F&f11=OP&bug_status=UNCONFIRMED,NEW,READY,ASSIGNED,REOPENED&o12=equals&v1=%2B%2C%3F&f6=cf_status_firefox" + nightly_version + "&n6=1"
...
urls = [
    ...
    (5, ["Tracked or Nominated for Tracking with Need-Info? Nightly " + nightly_version + " Bugs", "needinfo_central", needinfo_central_url]),
    ...
    (0, ["Bugs Tracked for Nightly " + nightly_version, "tracking_central", tracking_central_url]),
    ...
    (3, ["Tracked Nightly " + nightly_version + " Bugs, untouched this week", "untouched_tracking_nightly", tracking_central_touch_url])
]
