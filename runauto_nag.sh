...
# Pretty common
python -m auto_nag.scripts.mismatch-priority-tracking-release -d
python -m auto_nag.scripts.mismatch-priority-tracking-beta -d
python -m auto_nag.scripts.mismatch-priority-tracking-nightly -d
