...
pip2 install -r requirements.txt && pip3 install  -r requirements.txt
...
python2 -m auto_nag.scripts.workflow.multi_nag

# reporter has a needinfo and no activity for the last X weeks
# Pretty common
python2 -m auto_nag.scripts.newbie_with_ni -d
